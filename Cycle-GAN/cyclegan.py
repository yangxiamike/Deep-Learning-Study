...
class CycleGAN():
    ...
    def sample_images(self, epoch, batch_i):
        ...
        os.makedirs('%s/images_3' %self.dataset_name,exist_ok=True)
        np.save('%s/images_3/%d_%d.npz' %(self.dataset_name,epoch,batch_i),gen_imgs)
...
if __name__ == '__main__':
    gan = CycleGAN()
    gan.train(epochs=1000, batch_size=16, sample_interval=50)
